...
class FrankaRobotState:
    ...
    arm_joint_position: np.ndarray = field(default_factory=lambda: np.zeros(7))
    arm_joint_velocity: np.ndarray = field(default_factory=lambda: np.zeros(7))
    ...
    arm_jacobian: np.ndarray = field(default_factory=lambda: np.zeros((6, 7)))
